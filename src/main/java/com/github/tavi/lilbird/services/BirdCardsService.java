...
public class BirdCardsService {
     ...
     * @see             NameGroupEntry
     */
    public NameGroupEntry save(@NotNull NameGroupEntry name) {
        log.saving(name);
     ...
     */
    public List<NameGroupEntry> getNamesOf(final long entryId) {
        final List<NameGroupEntry> synonyms = namesRepo.findByReference(entryId);
        return synonyms;
    }
     ...
     * @return              A list of synonymous names for this bird.
     */
    public List<NameGroupEntry> getNamesOf(@NotNull final BirdEntry entry) {
    ...
    private static class ServiceLogger {
         ...
         */
        void saving(final NameGroupEntry synonym) {
