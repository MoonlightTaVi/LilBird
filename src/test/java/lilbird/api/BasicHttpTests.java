...
public class BasicHttpTests {
    ...
    private static BirdCard cardDto;
    ...
    public static void setup() {
        cardDto = new BirdCard();
        cardDto.setNameLatin("Raven");

        final BasicNameGroup altNames = new BasicNameGroup();
        altNames.addName("RAVEN");
        altNames.setEtymology("Same, but CAPS.");
        cardDto.addNameGroup(altNames);
    }
